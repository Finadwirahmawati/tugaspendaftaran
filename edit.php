        ...
        <form action="proses_edit_daftar.php"method="POST">
            <fieldset>
                ...
                <p>
                    ...
                    <label><input type="radio" name="jk" value="laki-laki" <?php echo ('laki-laki') ?"checked": "" ?>/></label>
                    <label><input type="radio" name="jk" value="perempuan" <?php echo ('perempuan') ?"checked": "" ?>/></label>
                <p>
